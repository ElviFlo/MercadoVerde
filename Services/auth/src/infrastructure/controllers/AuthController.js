...
var AuthController = /** @class */ (function () {
    ...
    AuthController.register = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, email, password, useCase, user, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, username = _a.username, email = _a.email, password = _a.password;
                        useCase = new RegisterUser_1.RegisterUser(repo);
                        return [4 /*yield*/, useCase.execute(username, email, password)];
                    case 1:
                        user = _b.sent();
    ...
    AuthController.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, password, useCase, token, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, username = _a.username, password = _a.password;
                        useCase = new LoginUser_1.LoginUser(repo);
                        return [4 /*yield*/, useCase.execute(username, password)];
                    case 1:
                        token = _b.sent();
    ...
    AuthController.validate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var token, useCase, decoded, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        token = req.body.token;
                        useCase = new ValidateToken_1.ValidateToken();
