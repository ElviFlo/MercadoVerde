...
var LoginUser = /** @class */ (function () {
    ...
    LoginUser.prototype.execute = function (username, password) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!isValid)
                            throw new Error("Credenciales inválidas");
                        return [2 /*return*/, jwt.sign({ id: user.id, username: user.username }, jwt_config_1.jwtConfig.secret, { expiresIn: "1h" })];
                }
            });
        });
    };
