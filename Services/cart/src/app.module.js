...
var get_cart_use_case_1 = require("./application/use-cases/get-cart.use-case");
var remove_from_cart_use_case_1 = require("./application/use-cases/remove-from-cart.use-case");
var AppModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            controllers: [cart_controller_1.CartController],
            providers: [
                { provide: 'CartRepository', useClass: cart_repository_impl_1.CartRepositoryImpl },
                cart_repository_impl_1.CartRepositoryImpl, // por si inyectas por tipo en algún lugar
                add_to_cart_use_case_1.AddToCartUseCase,
                get_cart_use_case_1.GetCartUseCase,
