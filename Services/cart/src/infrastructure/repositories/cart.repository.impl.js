...
var CartRepositoryImpl = function () {
    ...
    var CartRepositoryImpl = _classThis = /** @class */ (function () {
        ...
        CartRepositoryImpl_1.prototype.addItem = function (userId, productId, quantity, price) {
            return __awaiter(this, void 0, void 0, function () {
                var now, idx, it, updated, created;
                return __generator(this, function (_a) {
                    now = new Date();
                    idx = this.items.findIndex(function (i) { return i.userId === userId && i.productId === productId; });
                    if (idx >= 0) {
                        it = this.items[idx];
                        updated = __assign(__assign({}, it), { quantity: it.quantity + quantity, price: price, updatedAt: now });
        ...
        CartRepositoryImpl_1.prototype.getItems = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.items.filter(function (i) { return i.userId === userId; })];
                });
            });
        };
