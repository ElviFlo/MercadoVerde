...
var ProductRepository = /** @class */ (function () {
            ...
            return __generator(this, function (_f) {
                return [2 /*return*/, this.prisma.product.create({
                        data: {
                            ...
                            categoryId: (_b = data.categoryId) !== null && _b !== void 0 ? _b : null,
                            createdBy: (_c = data.createdBy) !== null && _c !== void 0 ? _c : 'unknown',
                            active: (_d = data.active) !== null && _d !== void 0 ? _d : true,
                            stock: (_e = data.stock) !== null && _e !== void 0 ? _e : 0,
                        },
                    })];
            });
        });
    ...
    ProductRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.prisma.product.findUnique({
                        where: { id: id },
                    })];
            });
        });
    };
    ProductRepository.prototype.update = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
