...
var UpdateOrderStatusUseCase = /** @class */ (function () {
    function UpdateOrderStatusUseCase(orderRepository) {
     ...
     */
    UpdateOrderStatusUseCase.prototype.execute = function (id, status) {
        return __awaiter(this, void 0, void 0, function () {
            var order, validStatuses, updated;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.orderRepository.findById(id)];
                    case 1:
                        order = _a.sent();
                        if (!order) {
                        ...
                        // 3. Actualizar estado
                        order.status = status;
                        return [4 /*yield*/, this.orderRepository.update(order)];
                    case 2:
                        updated = _a.sent();
