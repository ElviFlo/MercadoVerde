...
var RegisterUser = /** @class */ (function () {
    function RegisterUser(userRepository) {
     ...
     * - Hash de contraseña
     */
    RegisterUser.prototype.execute = function (name, email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var existingByEmail, hashed, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        hashed = _a.sent();
                        user = new User_1.User("", // id: string (UUID) → lo asigna la DB
                        name.trim(), email.trim().toLowerCase(), hashed, "client");
                        // 4) Persistir
