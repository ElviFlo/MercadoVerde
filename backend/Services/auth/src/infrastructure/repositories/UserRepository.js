...
var UserRepository = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new User_1.User(String(u.id), // asegura string
                            (_a = u.name) !== null && _a !== void 0 ? _a : "", // evita null
                            u.email, u.password, mapRoleFromDb(u.role), u.createdAt)];
                }
            });
        });
    };
    UserRepository.prototype.findByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var u;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, prisma.user.findFirst({ where: { name: name } })];
                    case 1:
                        u = _b.sent();
                        if (!u)
                            return [2 /*return*/, null];
                        return [2 /*return*/, new User_1.User(String(u.id), (_a = u.name) !== null && _a !== void 0 ? _a : "", u.email, u.password, mapRoleFromDb(u.role), u.createdAt)];
                }
            });
        });
    };
    ...
    UserRepository.prototype.updateRole = function (userId, role) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
