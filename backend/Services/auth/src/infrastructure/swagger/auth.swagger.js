...
function setupSwagger(app) {
    ...
    try {
        ...
        var options = {
            definition: {
                ...
                info: {
                    ...
                    version: "1.0.0",
                    description: "Servicio de autenticación con separación de vistas por **admin** (creado automáticamente al arrancar) y **client** (registrados por formulario).",
                },
        ...
        var spec_1 = swaggerJsdoc(options);
        app.get("/docs.json", function (_req, res) { return res.json(spec_1); });
        app.use("/docs", swaggerUi.serve, swaggerUi.setup(spec_1, {
            explorer: true,
