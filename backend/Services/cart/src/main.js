            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    config = new swagger_1.DocumentBuilder()
                        ...
                        .addTag('Cart', 'Operaciones sobre el carrito del usuario autenticado (client o admin). ' +
                    ...
                    // /docs.json crudo
                    app.getHttpAdapter()
                        .get('/docs.json', function (_req, res) { return res.json(document); });
                    port = Number((_a = process.env.PORT) !== null && _a !== void 0 ? _a : 3005);
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _b.sent();
                    console.log("\uD83D\uDFE2 Cart service running on http://localhost:".concat(port, "/docs (Swagger UI)"));
                    return [2 /*return*/];
            }
        });
    });
